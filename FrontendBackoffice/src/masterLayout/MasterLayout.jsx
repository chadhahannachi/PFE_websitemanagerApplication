...
import NotificationBell from "../Backoffice/Notification/NotificationsBell.tsx";
        ...
        <div className='sidebar-menu-area'>
          <ul className='sidebar-menu' id='sidebar-menu'>
            ...
            {/* <li>
              ...
              >
                <Icon icon='mdi:archive-outline' className='menu-icon' />
                <span>Archive</span>
              </NavLink>
            </li> */}


            {/* Affichage conditionnel du menu Dashboard pour superadminabshore */}
          ...
          <li className='sidebar-menu-group-title'>Archive</li>
          ...
          {!loadingRole && userRole === 'superadminabshore' && (
            <li>
              ...
              >
                <Icon icon='mdi:archive-outline' className='menu-icon' />
                <span>Archived Companies</span>
              </NavLink>
            </li>
          )}


{!loadingRole && userRole === 'superadminentreprise' && (
            <li>
              <NavLink
                to='/ArchiveContent'
                className={(navData) => (navData.isActive ? "active-page" : "")}
            ...
            <li className='sidebar-menu-group-title'>Data</li>
            ...
            <li className={`dropdown${openDropdown === 'users' ? ' open' : ''}`}>
              <Link to='#' onClick={() => setOpenDropdown(openDropdown === 'users' ? null : 'users')}>
                <Icon icon='flowbite:users-group-outline' className='menu-icon' />
                <span>Users Management</span>
              </Link>
              <ul className='sidebar-submenu' style={{ maxHeight: openDropdown === 'users' ? '1000px' : '0px', transition: 'max-height 0.3s' }}>
                <li>
                  <NavLink
                    to='/Team'
                    className={(navData) =>
          ...
          {!loadingRole && ['superadminabshore', 'superadminentreprise'].includes(userRole) && (
            ...
            <li className={`dropdown${openDropdown === 'company' ? ' open' : ''}`}>
              <Link to='#' onClick={() => setOpenDropdown(openDropdown === 'company' ? null : 'company')}>
                <Icon icon='mdi:office-building-outline' className='menu-icon' />
                <span>Company Management</span>
              </Link>
              <ul className='sidebar-submenu' style={{ maxHeight: openDropdown === 'company' ? '1000px' : '0px', transition: 'max-height 0.3s' }}>
                {!loadingRole && userRole === 'superadminabshore' && (
                <li>
                  <NavLink
                    to='/CompanyList'
            ...
            <li className='dropdown'>
              <Link to='#'>
                <Icon icon='mdi:license' className='menu-icon' />
            ...
            <li className='sidebar-menu-group-title'>Project</li>
            ...
            {!loadingRole && ['moderateur', 'superadminentreprise'].includes(userRole) && (
            ...
            <li>
              <NavLink
                ...
                className={(navData) => (navData.isActive ? "active-page" : "")}
              >
                <Icon icon='mdi:web-box' className='menu-icon' />
            ...
            <li className='dropdown'>
              <Link to='#'>
                <Icon icon='mdi:widgets-outline' className='menu-icon' />
            ...
            {!loadingRole && userRole === 'superadminabshore' && (
            <li className={`dropdown${openDropdown === 'role' ? ' open' : ''}`}>
              <Link to='#' onClick={() => setOpenDropdown(openDropdown === 'role' ? null : 'role')}>
                <i className='ri-user-settings-line' />
                <span>Role &amp; Access</span>
              </Link>
              <ul className='sidebar-submenu' style={{ maxHeight: openDropdown === 'role' ? '1000px' : '0px', transition: 'max-height 0.3s' }}>
                <li>
                  <NavLink
                    to='/role-access'
                    className={(navData) =>
            ...
            <div className='col-auto'>
              <div className='d-flex flex-wrap align-items-center gap-3'>
                ...
                <div className='dropdown'>
                  ...
                  >
                    <img
                      src={userProfile?.image || '/assets/images/user.png'}
                      alt='image_user'
